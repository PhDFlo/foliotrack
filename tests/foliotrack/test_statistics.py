...
class MockMarketService(MarketService):
    def get_historical_data(self, tickers, start_date):
        ...
        prices_B = [100.0, 105.0, 110.0, 108.0, 106.0, 110.0, 115.0, 120.0, 118.0, 115.0]
        # Benchmark
...
def test_statistics_calculation():
    ...
    results = statistics_service.compute_statistics(portfolio, metrics=metrics, start_date=start_date)
